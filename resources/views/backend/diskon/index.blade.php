    ...
    <div class="col-12">
        <div class="card-box">
            <div class="row">
                ...
                <div>
                    <a href="#custom-modal" class="btn btn-primary btn-rounded waves-light waves-effect w-md mr-2 mb-2" data-animation="fadein" data-plugin="custommodal"
                    data-overlaySpeed="200" data-overlayColor="#36404a">New Voucher</a>
                </div>
            </div>
