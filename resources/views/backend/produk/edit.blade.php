            ...
            <form action="{{ route('produk.update', $produk->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    {{-- <div class="row"> --}}
                        ...
                        <div class="col-md-3 col--xs6">
                            <input required type="number" value="{{$produk->berat}}" min="1" name="berat" placeholder="Berat Produk" class="form-control">
                        </div>
                        <div class="col-md-3 col--xs6">
                            <select name="stok" id="" class="form-control">
                                <option value="{{$produk->stok}}">{{$produk->stok}}</option>
                                <option value="Tersedia">Tersedia</option>
                                <option value="Kosong">Kosong</option>
                            </select>
                            {{-- <input required type="number" value="{{$produk->stok}}" min="0" name="stok" placeholder="Stok Produk" class="form-control"> --}}
                        </div>
                    {{-- </div> --}}
                </div>
                <br/>
